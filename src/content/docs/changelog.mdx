...
## 3/23/2026
- Cleaned up unused imports in pages
- removed light/dark mode toggle, locked site to dark mode only

## 1/07/2026
- Package updates
- Updated about me badges and bio to match github bio.
- Edited manual overview and opened Dart, HTML, and Python manuals.

## 12/24/2025

### General Updates
- Cleaned up file structure in project folder
- Updated descriptions of subfolder overview docs for continuity
- removed image zoom plugin, really didn't work too well tbh

### Reference Manuals
- Added reference manuals folder with overview page.
- Added drafts for Digital Logic, Dart, HTML, and Python manuals.

## 12/18/2025

- Updated familiar languages in about entry
- added badge resources to thanks page


## 8/11/2025
- Improved light mode CSS theme

## 8/10/2025
- Updated all sites to new starlight social links

## 5/26/2025
- Updated Nixie Clock BOM from Altium Designer Project File
