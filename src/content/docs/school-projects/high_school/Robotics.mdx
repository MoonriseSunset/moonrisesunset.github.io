...
This section is a bit terse since I no longer have access to past images and documentation. For both of the seasons on Botcats, I held a leadership role specializing in hardware. 
...
As a rookie hardware member on Darkness Rising, I learned how to use CAD software, mainly Tinkercad and a litle Solidworks, and build FTC robots, something I wasn't used to coming from LEGO robotics.
