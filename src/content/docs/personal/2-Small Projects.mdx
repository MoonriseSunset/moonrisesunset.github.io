...
---
<LinkCard title="Github Repo" target="_blank" href="https://github.com/MoonriseSunset/Niagara" description=""/>
...
Back then, I was still learning CSS, the language used for controlling your site's colors, spacing, and fonts, so when it came time to put colors on my site, I would just chuck random colors in and saw what stuck.
...
---
<LinkCard title="Github Repo" target="_blank" href="https://github.com/MoonriseSunset/Hephaestus"/>
